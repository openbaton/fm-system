...
public class ManagedNetworkServiceRecordRepositoryImpl implements ManagedNetworkServiceRecordRepositoryCustom {

    @Autowired
    ManagedNetworkServiceRecordRepository mnsrRepo;
    @Autowired
    VduPmJobsRepository vduPmJobsRepository;
    @Autowired
    ThresholdHostnamesRepository thresholdHostnamesRepository;
    ...
    @Override
    @Transactional
    public ManagedNetworkServiceRecord addThresholdHostnames(String nsrId, String thresholdId, ThresholdHostnames thresholdHostnames) {
        ManagedNetworkServiceRecord mnsr = mnsrRepo.findByNsrId(nsrId);
        if(mnsr!=null){
    ...
    @Override
    @Transactional
    public ManagedNetworkServiceRecord addFmPolicyId(String nsrId, String thresholdId, String fmPolicyId) {
        ManagedNetworkServiceRecord mnsr = mnsrRepo.findByNsrId(nsrId);
        if(mnsr!=null){
