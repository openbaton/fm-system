...
package org.openbaton.faultmanagement.receivers.interfaces;
...
public interface EventReceiver {
  ...
  Alarm receiveVnfStateChangedAlarm(
      VNFAlarmStateChangedNotification vnfAlarmStateChangedNotification);

  Alarm receiveVRNewAlarm(VirtualizedResourceAlarmNotification vrAlarm);

  Alarm receiveVRStateChangedAlarm(
      VirtualizedResourceAlarmStateChangedNotification abstractVNFAlarm);
}
