...
public class NFVORequestorWrapperImpl implements NFVORequestorWrapper {
    ...
    @Override
    public void deleteVnfcInstance(String nsrId, String vnfrId, String vduId, String vnfcInstanceId) throws SDKException {
        nfvoRequestor.getNetworkServiceRecordAgent().deleteVNFCInstance(nsrId,vnfrId,vduId,vnfcInstanceId);
    }


    @Override
    public void createStandbyVNFCInstance(String nsrId, String vnfrId, String vduId, VNFComponent vnfComponent) throws SDKException {
        nfvoRequestor.getNetworkServiceRecordAgent().createVNFCInstanceInStandby(nsrId, vnfrId, vduId, vnfComponent);
    }
    @Override
    public void switchToStandby(String nsrId,String vnfrId, String vduId, String vnfcId, VNFCInstance failedVnfcInstance) throws SDKException {
        nfvoRequestor.getNetworkServiceRecordAgent().switchToStandby(nsrId,vnfrId,vduId,vnfcId,failedVnfcInstance);
    }
    ...
    public void executeHeal(String nsrid, String vnfrId, String vduId,String failedVnfcInstanceId,String cause) throws SDKException {
        NFVMessage nfvMessage = getHealMessage(cause);
        nfvoRequestor.getNetworkServiceRecordAgent().postAction(nsrid,vnfrId,vduId,failedVnfcInstanceId,nfvMessage);
    }
